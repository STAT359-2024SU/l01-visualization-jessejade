...
A geom is a geometric object that is used in ggplot2 to visualize data. We can layer multiple onto a plot such as geom_line and geom_point. 

Aesthetic mapping dictates which variables in our data connect to certain aesthetics. For example, we can map a categorical variable to color and shape on a scatterplot to identify group trends.
