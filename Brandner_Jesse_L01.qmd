...
The function geom_jitter() places points randomly away from their original spots. The plot changes on every run. To fix this, we can set a random seed before plotting (set.seed(123)) to make the jitter reproducible.
